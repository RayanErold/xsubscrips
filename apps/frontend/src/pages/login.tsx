      ...
      <div className="w-full max-w-md backdrop-blur-xl bg-background/60 border border-white/20 dark:border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            {isSignUp ? "Join X Subscrips today" : "Sign in to your account"}
          </p>
        </div>
        ...
        <form onSubmit={handleEmailAuth} className="space-y-5">
            ...
            <div className="flex gap-4">
              <div className="space-y-2 flex-1">
                ...
                <Input
                  ...
                  className="bg-white/50 dark:bg-black/50 border-white/20 h-12 rounded-xl"
                  required
                />
              </div>
              <div className="space-y-2 flex-1">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-background/80 backdrop-blur-md px-2 text-muted-foreground">Or</span>
            </div>
          </div>
          ...
          <Button
            ...
            className="w-full h-12 rounded-xl border-white/20 bg-white/5 hover:bg-white/10 transition-all"
          >
        ...
        <p className="text-center mt-8 text-sm text-muted-foreground">
          {isSignUp ? "Already have an account?" : "New to X Subscrips?"}{" "}
          <button 
            type="button"
